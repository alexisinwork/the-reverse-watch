...
A 2026-08-31 exact-reference search and official-page recheck found no new
...
lug-width decisions remain controlled by primary sources; the four M1 gaps stay
null and no provider request is authorized.
...
review gaps stay null and the candidate remains research-only.
...
description is subjective and untimed. No value is promoted, and both review
gaps remain null.
...
observation period, or test method. The sole `accuracy` gap therefore remains
null and no provider request is authorized.
...
A 2026-08-31 exact-SKU recheck found no new admissible lume evidence for Nodus
SEC-F-SHA. The manufacturer and exact reseller still provide only BGW9 Grade A
material language or uncontrolled rapid-charging impressions, with no timed
charge/decay series or repeatable comparison grade. `lumeGrade` remains null and
the candidate stays research-only.
...
elapsed-decay series, or repeatable comparison; `lumeGrade` remains null.
...
and sole `lumeGrade` gap remain unresolved.
...
A 2026-08-31 exact-reference search found only the same Casio LED
Super Illuminator/backlight evidence. Because the light is not
photoluminescent and no timed charge/decay protocol exists, `lumeGrade` remains
null and the candidate stays research-only.
...
A 2026-08-31 exact-reference check of an additional Certina-authorized Finnish
retailer confirms the titanium bracelet and Powermatic 80.611 configuration but
publishes no numerical rate tolerance. The exact accuracy field therefore
remains null; neither the unattributed `-10/+25` reseller claim nor Certina's
approximate family guidance is promoted.
